"""
Refactored version of the credit analysis system using functions.

This version improves readability and maintainability by:
- Reducing nested conditionals using early returns
- Separating validation logic into smaller functions
- Applying a fail-fast approach
"""
def check_age(age):
